...
public class LoginRequest extends StringRequest {
    ...
    public LoginRequest(String userEmail, String userPassword, Response.Listener<String> listener, final Context context)
    {
        ...
        parameters.put("login",informationObject.toString());
