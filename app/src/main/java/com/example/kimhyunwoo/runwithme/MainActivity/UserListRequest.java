...
public class UserListRequest extends StringRequest {
    final static private String URL = serverURL + userlistURL;                          // URL 헤더파일로 묶어서 수정해야함.
    ...
    public UserListRequest(Response.Listener<String> listener, final Context context)
    {
        super(Request.Method.POST,URL,listener,new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.v("User's Log","Server connecet Error");
            }
        });
