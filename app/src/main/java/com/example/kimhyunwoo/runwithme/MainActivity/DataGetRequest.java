...
public class DataGetRequest extends StringRequest {
    ...
    public DataGetRequest(String date, String datatype, String period, Response.Listener<String> listener, final Context context)
    {
        ...
        try{
            ...
            informationObject.put("datatype",datatype);
            informationObject.put("period",period);
